...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppGeneratorGeneratorComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _generator_generator_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var routes = [{
      ...
      path: 'generator',
      component: _generator_generator_component__WEBPACK_IMPORTED_MODULE_4__["GeneratorComponent"]
    }, {
      path: 'payments',
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _generator_generator_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./generator/generator.component */
    "./src/app/generator/generator.component.ts");
    /* harmony import */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _home_home_component__WEBPACK_IMPORTED_MODULE_5__["HomeComponent"], _generator_generator_component__WEBPACK_IMPORTED_MODULE_6__["GeneratorComponent"], _payments_payments_component__WEBPACK_IMPORTED_MODULE_7__["PaymentsComponent"]],
  ...
  /***/
  function srcAppGeneratorGeneratorComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppGeneratorGeneratorComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var GeneratorComponent = /*#__PURE__*/function () {
      function GeneratorComponent(service) {
        ...
        this.numbers = Array(10).fill(0).map(function (x, i) {
          return i;
        });
      }
      ...
      _createClass(GeneratorComponent, [{
        ...
        key: "updateChar",
        value: function updateChar(customChar, event) {
          var _this = this;
        ...
        key: "genRandomgrid",
        value: function genRandomgrid() {
          var _this2 = this;

          var withCustomChar = this["char"] !== '';
          this.hundredArray = Array(100).fill(0).map(function (x, i) {
            return i;
          });
          var defaultLib = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z'];
          var allCells = Array.from(document.querySelectorAll("[class^=row_]"));
          allCells.forEach(function (cell) {
            return cell.innerHTML = '';
          });
          var randIndexCell = this.shuffle(this.hundredArray);
          this.usedIndex = [];

          if (withCustomChar) {
            for (var i = 0; i < 20; i++) {
              var index = randIndexCell[0];
              allCells[index].innerHTML = this["char"];
              randIndexCell.splice(0, 1);
            }

            for (var j = 0; j < 80; j++) {
              var _index = randIndexCell[0];
              var indexChar = this.getRandNumber(26);
              allCells[_index].innerHTML = defaultLib[indexChar];
              randIndexCell.splice(0, 1);
            }
          } else {
            for (var _j = 0; _j < 100; _j++) {
              var _index2 = randIndexCell[0];

              var _indexChar = this.getRandNumber(26);

              allCells[_index2].innerHTML = defaultLib[_indexChar];
              randIndexCell.splice(0, 1);
            }
          }
          ...
          if (this.interval === 0) {
            this.interval = setInterval(function () {
              _this2.genRandomgrid();
            }, 2000);
          }
        }
      }, {
        key: "getRandNumber",
        value: function getRandNumber(max) {
        ...
        value: function updateCode() {
          var allCells = Array.from(document.querySelectorAll("[class^=row_]"));
          var date = new Date();
          var seconds = date.toString().split(' ')[4].split(':')[2];
          var number1 = seconds.split('')[0];
          var number2 = seconds.split('')[1];
          var codeLetter1 = allCells.find(function (x) {
            return x.className === 'row_' + number1 + 'c' + number2;
          }).innerHTML;
          var codeLetter2 = allCells.find(function (x) {
            return x.className === 'row_' + number2 + 'c' + number1;
          }).innerHTML;
          var count1 = this.getLowestNumber(allCells.filter(function (x) {
            return x.innerHTML === codeLetter1;
          }).length);
          var count2 = this.getLowestNumber(allCells.filter(function (x) {
            return x.innerHTML === codeLetter2;
          }).length);
          this.code = count1.toString() + count2.toString();
          var paymentObj = {
            name: 'payment' + this.paymentNumber,
            ammount: '',
            code: this.code,
            grid: ''
          };
        ...
        key: "getLowestNumber",
        value: function getLowestNumber(number) {
          var divider = 2;
    ...
    GeneratorComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/generator/generator.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./generator.component.scss */
      "./src/app/generator/generator.component.scss"))["default"]]
    })], GeneratorComponent);
    /***/
  },
  ...
  /***/
  function srcAppPaymentsPaymentsComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppPaymentsPaymentsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PaymentsComponent = /*#__PURE__*/function () {
      function PaymentsComponent(service) {
      ...
      _createClass(PaymentsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          setInterval(function () {
            _this3.service.getData().subscribe(function (res) {
              if (_this3.result.length === 0) {
                _this3.result = res;
              } else {}

              _this3.code = _this3.result[_this3.result.length - 1].code;
            });
          }, 2000);
        }
      }, {
        key: "addPaymentValue",
        value: function addPaymentValue() {
          var _this4 = this;

          var selectedRes = this.result.find(function (x) {
            return x.name === _this4.paymentValue;
          });
    ...
    PaymentsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/payments/payments.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./payments.component.scss */
      "./src/app/payments/payments.component.scss"))["default"]]
    })], PaymentsComponent);
    /***/
  },
  ...
  function srcAppServicesCommonServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CommonService = /*#__PURE__*/function () {
      ...
      _createClass(CommonService, [{
        ...
        key: "postPayment",
        value: function postPayment(payment) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/gustavopassos/WebstormProjects/gig-ng-public/challenge/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
